...
{id:'insta', t:'text', req:0, q:'Instagram', ph:'link ou @ (se ativo)'},
{id:'tiktok', t:'text', req:0, q:'TikTok', ph:'link ou @ (se ativo)'},
...
{id:'s4', eyebrow:'Bloco 04', title:'Faturamento e pagamento', sub:'O pagamento de comissões e bônus é feito mediante nota fiscal (PJ). Os dados bancários devem ser do mesmo CNPJ que emitir a nota. Não pagamos em conta de terceiros nem de pessoa física.', qs:[
